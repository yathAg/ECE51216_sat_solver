...
for file in _benchmarks/*.cnf; do
    ...
    if timeout 120m python3 SatSolver.py "$file" > "_decay5_no_restarts/${filename_no_ext}_output.txt"; then
        ...
        echo "RESULT: Skipped file" > "_decay5_no_restarts/${filename_no_ext}_output.txt"
